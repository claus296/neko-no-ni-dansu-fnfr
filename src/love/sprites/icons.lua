...
return graphics.newSprite(
	...
	},
	{
		...
		["nyanyo 2"] = {start = 3, stop = 3, speed = 0, offsetX = 0, offsetY = 0},
		["nyanyo 2 losing"] = {start = 4, stop = 4, speed = 0, offsetX = 0, offsetY = 0},
		["nyanyo 3"] = {start = 5, stop = 5, speed = 0, offsetX = 0, offsetY = 0},
		["nyanyo 3 losing"] = {start = 6, stop = 6, speed = 0, offsetX = 0, offsetY = 0},
		...
		["boyfriend 2"] = {start = 11, stop = 11, speed = 0, offsetX = 0, offsetY = 0},
		["boyfriend 2 losing"] = {start = 12, stop = 12, speed = 0, offsetX = 0, offsetY = 0},
		["nyanyo"] = {start = 13, stop = 13, speed = 0, offsetX = 0, offsetY = 0},
		["nyanyo losing"] = {start = 14, stop = 14, speed = 0, offsetX = 0, offsetY = 0},
